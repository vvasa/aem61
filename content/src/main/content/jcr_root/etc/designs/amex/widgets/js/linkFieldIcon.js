...
*  {type:"", url:"", text:""}
*/
CQ.form.LinkFieldIcon = CQ.Ext.extend(CQ.form.CompositeField, {
    /*
    ...
    */
    ...
    constructor:function(config){
        ...
        CQ.form.LinkFieldIcon.superclass.constructor.call(this, config);
    },

    initComponent:function(){
        CQ.form.LinkFieldIcon.superclass.initComponent.call(this);
        ...
        this.iconURL = new CQ.form.PathField({
            cls:"customwidget-4",
            hideLabel:false,
            fieldLabel:"Icon :",
            fieldDescription:"Select Icon Image",
            anchor:'100%',
            listeners:{
                change:{
                    scope:this,
    ...
    processinit: function(path,record){
        ...
        this.iconURL.processInit(path,record);
    },
    ...
    setValue:function(value){
        ...
        this.iconURL.setValue(link.iconurl);
...
CQ.Ext.reg("linkfieldicon", CQ.form.LinkFieldIcon);
